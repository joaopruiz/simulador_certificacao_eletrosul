...
public class Relatorio5{
    ...
    public void abrirRelatorio() {
    	InputStream inputStream = getClass().getResourceAsStream("/perguntas_acertos_pizza.jasper");
        ...
        try {
        	...
        	ReportUtils.openReport( "Simulador Certificação - Relatório - Perguntas com mais Acertos", inputStream, parametros,
                   conexao1.getConexao() );
