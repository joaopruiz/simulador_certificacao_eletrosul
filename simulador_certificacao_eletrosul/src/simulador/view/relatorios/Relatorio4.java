...
public class Relatorio4 {
    ...
    public void abrirRelatorio() {
    	InputStream inputStream = getClass().getResourceAsStream("/perguntas_erros_pizza.jasper");
        ...
        try {
        	...
        	ReportUtils.openReport( "Simulador Certificação - Relatório - Perguntas com mais Erros", inputStream, parametros,
                   conexao1.getConexao() );
