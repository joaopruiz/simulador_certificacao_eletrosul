...
public class Relatorio3 {
    ...
    public void abrirRelatorio() {
    	InputStream inputStream = getClass().getResourceAsStream("/assuntos_erros_pizza.jasper");
        ...
        try {
        	...
        	ReportUtils.openReport( "Simulador Certificação - Relatório - Assuntos com mais Erros", inputStream, parametros,
                   conexao1.getConexao() );
