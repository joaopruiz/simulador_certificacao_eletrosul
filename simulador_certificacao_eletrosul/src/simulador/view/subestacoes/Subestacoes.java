package simulador.view.subestacoes;
...
import simulador.model.subestacoes.Subestacaotb;
import simulador.model.subestacoes.Subestacoes_metodos;
import simulador.view.CellRenderer;
import java.awt.Dimension;

public class Subestacoes extends JDialog {
	 ...
	 * @param owner
	 */
	public Subestacoes(Frame owner) {
		super(owner);
		initialize();
	}
	...
	private void initialize() {
		...
		this.setTitle("Simulador de Certificação - Gerenciar Subestações");
		AtualizarJTable();
	...
	private void AtualizarJTable(){
		try {
			Subestacoes_metodos sub1 = new Subestacoes_metodos();
	...
	private JPanel getJPanelinferior() {
		if (jPanelinferior == null) {
			...
			jLabel_nomecontroladora.setText("Controladora:");
			...
			gridBagConstraints7.insets = new Insets(10, 10, 10, 264);
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if(jTextField_subestacaonometxt.getText().equals("") || jTextField_subestacaonometxt.getText().equals(null)){
						...
						if(jTextField_nomecontroladoratxt.getText().equals("") || jTextField_nomecontroladoratxt.getText().equals(null)){
							...
							Subestacoes_metodos sub1 = new Subestacoes_metodos();
							Subestacaotb subestacoestb = new Subestacaotb(Integer.parseInt(jTextField_id_subestacoes.getText()), jTextField_subestacaonometxt.getText(), jTextField_nomecontroladoratxt.getText());
							sub1.atualizar_registroJtable(subestacoestb);
							jButton_Atualizar.setEnabled(false);
							jButton_Apagar.setEnabled(false);
							LimpareDesabilitarCampos();
							AtualizarJTable();
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if(jTextField_subestacaonometxt.getText().equals("") || jTextField_subestacaonometxt.getText().equals(null)){
						...
						if(jTextField_nomecontroladoratxt.getText().equals("") || jTextField_nomecontroladoratxt.getText().equals(null)){
							...
							Subestacoes_metodos sub1 = new Subestacoes_metodos();
							int i=0;
							Subestacaotb subestacoestb = new Subestacaotb(i, jTextField_subestacaonometxt.getText(), jTextField_nomecontroladoratxt.getText());
							sub1.Salvar_novo_registroJtable(subestacoestb);
							LimpareDesabilitarCampos();
							AtualizarJTable();
							jButton_salvar.setEnabled(false);
						}
