package simulador.view.Autores;
...
public class Autores extends JDialog {
	...
	private void initialize() {
		...
		this.setSize(new Dimension(620, 376));
		this.setTitle("Simulador de Certificação - Gerenciar Autores");
		AtualizarJTable();
	...
	private void AtualizarJTable(){
		try {
			Autores_metodos sub1 = new Autores_metodos();
		...
		if (jTable == null) {
			...
			jTable.addMouseListener(new java.awt.event.MouseAdapter() {   
				public void mousePressed(java.awt.event.MouseEvent e) {    
					...
					String b = (jTable.getModel().getValueAt(i, 3)).toString();
					//System.out.println("row: "+i+" dado: "+a);
					jTextField_id_subestacoes.setText(f);
					jTextField_nomecontroladoratxt.setText(a);
					//jTextField_subestacaonometxt.setText(b);
					jComboBox.setEnabled(true);
					String c = (jTable.getModel().getValueAt(i, 2)).toString();
					//System.out.println();
					Subaux sub1 = new Subaux(c, b);
					atualizaroCombocomvariavel(sub1);
				}
			});
	...
	private JPanel getJPanelinferior() {
		if (jPanelinferior == null) {
			...
			gridBagConstraints13.insets = new Insets(10, 10, 10, 334);
		...
		if (jButton_Atualizar == null) {
			...
			jButton_Atualizar.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if(jTextField_nomecontroladoratxt.getText().equals("") || jTextField_nomecontroladoratxt.getText().equals(null)){
						...
						Autortb autortb = new Autortb(Integer.parseInt(jTextField_id_subestacoes.getText()), jTextField_nomecontroladoratxt.getText(), Integer.parseInt(sub.getUf()));
						sub1.atualizar_registroJtable(autortb);
						jButton_Atualizar.setEnabled(false);
						jButton_Apagar.setEnabled(false);
						LimpareDesabilitarCampos();
						AtualizarJTable();
			...
			jButton_salvar.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if(jTextField_nomecontroladoratxt.getText().equals("") || jTextField_nomecontroladoratxt.getText().equals(null)){
						...
						Subaux sub = (Subaux)jComboBox.getSelectedItem();
						int i=0;
						Autortb autortb = new Autortb(i, jTextField_nomecontroladoratxt.getText(), Integer.parseInt(sub.getUf()));
						sub1.Salvar_novo_registroJtable(autortb);
						LimpareDesabilitarCampos();
						AtualizarJTable();
						jButton_salvar.setEnabled(false);
					}	
	 ...
	 */
	private void atualizaroCombocomvariavel(Subaux sub1){
		try {
	...
	private JComboBox getJComboBox() {
		if (jComboBox == null) {
			...
			try {
				...
				jComboBox = autoresmetodos.PreencheojCombobox();
