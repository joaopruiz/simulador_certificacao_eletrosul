...
public class Login extends JDialog {
	...
	private void initialize() {
		...
		this.setTitle("Simulador de Certificação");
	...
	private JPanel getJPanel1_login() {
		if (jPanel1_login == null) {
			...
			jPanel1_login.setBorder(BorderFactory.createTitledBorder(null, "Autenticação", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
	...
	/*private JButton getJButton_configs() {
		if (jButton_configs == null) {
			...
			jButton_configs.setText("Configurações");
