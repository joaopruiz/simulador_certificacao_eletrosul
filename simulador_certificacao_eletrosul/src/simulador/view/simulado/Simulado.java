...
public class Simulado extends JFrame {
	 ...
	 * @param owner
	 */
	public Simulado(JanelaPai tela) {
		super();
		telapai = tela;
		initialize();
	}
	...
	private void initialize() {
		...
		pergunta = perguntasmetodos.getListadePerguntas();
		...
		JOptionPane.showMessageDialog(null,"ATENÇÃO!\n\n O simulado não possui tempo limite.\n " +
				...
				"O Simulado possui o mínimo de 5 perguntas e o máximo de 50 perguntas.\n\n " +
			...
			jButton_Avancar.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if(perguntaselecionada.equals("")){
						...
						//System.out.println(telapai.id_usuario+" save");
						//System.out.println(estatisticastb.getId_usuario()+" estatisticas");
